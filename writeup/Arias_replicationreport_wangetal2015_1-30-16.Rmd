...
```{r practice of loading data }


###(Borrowed from other students' scripts) -- need to clean for this study
#Reading the path
path <- "C:\\Users\\Juan\\Documents\\1. STANFORD\\2nd Year 15-16\\Psych254 Replication Methods\\Psych254 Project"
...
Power analysis: For an effect size of .02 with 219 participants, from a multiple regression with 9 total predictors in model, and an alpha of .05, the estimated power achieved is:  55% 
...
mathperflm4.alt <- lm(pvt ~ age + sex + genanx + I(genanx^2) + mathanx * mathmot + (I(mathanx^2) * mathmot),
                      data = subjectmeans)
