...
```{r model at different SDs, eval=FALSE}
...
mathperflm4_below <- lm(z.pvt ~ 2 + age + gender + z.genanx + I(z.genanx^2) + z.mathanx * I(z.mathmot + 1) + (I(z.mathanx^2) * I(z.mathmot + 1)), data = subjectmeans)

kable(summary(mathperflm4_below)$coef)

```

```{r plot of model at different motivation SDs, eval=FALSE}
